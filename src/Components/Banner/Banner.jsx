...
const Banner = () => {
  return (
      <div className=" bg-[url('./assets/bg.jpg')] relative py-[256px] after:contents-[''] after:w-full after:h-full after:top-0 after:left-0 after:bg-[#000] after:bg-opacity-50 after:absolute z-10 after:z-[-1]">
