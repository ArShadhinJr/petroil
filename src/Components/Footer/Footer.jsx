...
const Footer = () => {
  ...
  <path d="M17.5 7.5H16.25V8.75H17.5V17.5H2.5V8.75H3.75V7.5H2.5C2.16848 7.5 1.85054 7.6317 1.61612 7.86612C1.3817 8.10054 1.25 8.41848 1.25 8.75V17.5C1.25 17.8315 1.3817 18.1495 1.61612 18.3839C1.85054 18.6183 2.16848 18.75 2.5 18.75H17.5C17.8315 18.75 18.1495 18.6183 18.3839 18.3839C18.6183 18.1495 18.75 17.8315 18.75 17.5V8.75C18.75 8.41848 18.6183 8.10054 18.3839 7.86612C18.1495 7.6317 17.8315 7.5 17.5 7.5Z" fill="white"/>
                    ...
                    <div className='p-[6px] bg-primary rounded-full'><svg className="cursor-pointer" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
  ...
  <path d="M8.00303 4.40623C6.01553 4.40623 4.4124 6.00935 4.4124 7.99685C4.4124 9.98435 6.01553 11.5875 8.00303 11.5875C9.99053 11.5875 11.5937 9.98435 11.5937 7.99685C11.5937 6.00935 9.99053 4.40623 8.00303 4.40623ZM8.00303 10.3312C6.71865 10.3312 5.66865 9.28435 5.66865 7.99685C5.66865 6.70935 6.71553 5.66248 8.00303 5.66248C9.29053 5.66248 10.3374 6.70935 10.3374 7.99685C10.3374 9.28435 9.2874 10.3312 8.00303 10.3312ZM12.578 4.25935C12.578 4.72498 12.203 5.09685 11.7405 5.09685C11.2749 5.09685 10.903 4.72185 10.903 4.25935C10.903 3.79685 11.278 3.42185 11.7405 3.42185C12.203 3.42185 12.578 3.79685 12.578 4.25935ZM14.9562 5.10935C14.903 3.98748 14.6468 2.99373 13.8249 2.17498C13.0062 1.35623 12.0124 1.09998 10.8905 1.04373C9.73428 0.978101 6.26865 0.978101 5.1124 1.04373C3.99365 1.09685 2.9999 1.3531 2.17803 2.17185C1.35615 2.9906 1.10303 3.98435 1.04678 5.10623C0.981152 6.26248 0.981152 9.7281 1.04678 10.8843C1.0999 12.0062 1.35615 13 2.17803 13.8187C2.9999 14.6375 3.99053 14.8937 5.1124 14.95C6.26865 15.0156 9.73428 15.0156 10.8905 14.95C12.0124 14.8968 13.0062 14.6406 13.8249 13.8187C14.6437 13 14.8999 12.0062 14.9562 10.8843C15.0218 9.7281 15.0218 6.2656 14.9562 5.10935ZM13.4624 12.125C13.2187 12.7375 12.7468 13.2094 12.1312 13.4562C11.2093 13.8219 9.02178 13.7375 8.00303 13.7375C6.98428 13.7375 4.79365 13.8187 3.8749 13.4562C3.2624 13.2125 2.79053 12.7406 2.54365 12.125C2.17803 11.2031 2.2624 9.0156 2.2624 7.99685C2.2624 6.9781 2.18115 4.78748 2.54365 3.86873C2.7874 3.25623 3.25928 2.78435 3.8749 2.53748C4.79678 2.17185 6.98428 2.25623 8.00303 2.25623C9.02178 2.25623 11.2124 2.17498 12.1312 2.53748C12.7437 2.78123 13.2155 3.2531 13.4624 3.86873C13.828 4.7906 13.7437 6.9781 13.7437 7.99685C13.7437 9.0156 13.828 11.2062 13.4624 12.125Z" fill="white"/>
                ...
                <div className="w-2/12 text-sm text-white mt-[32px]">
                    <ul>
                        <li className='font-bold text-base '>Company</li>
                        <li className='mt-[15px]'>Home</li>
                        <li className='mt-[15px]'>About</li>
                        <li className='mt-[15px]'>Services</li>
                        <li className='mt-[15px]'>Gallery</li>
                    </ul>
                </div>
                <div className="w-2/12 text-sm text-white mt-[32px]">
                    <ul>
                        <li className='font-bold text-base '>Others</li>
                        <li className='mt-[15px]'>Blog</li>
                        <li className='mt-[15px]'>Contact</li>
